...
$GLOBALS['TCA']['tx_tournament_domain_model_playerko'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_tournament_domain_model_playerko']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_tournament_domain_model_playerko.pid=###CURRENT_PID### AND tx_tournament_domain_model_playerko.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:tournament/Resources/Private/Language/locallang_db.xlf:tx_tournament_domain_model_playerko.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
