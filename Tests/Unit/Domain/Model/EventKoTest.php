...
/**
 * Test case for class \Dennis\Tournament\Domain\Model\EventKo.
 *
 ...
 */
class EventKoTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Dennis\Tournament\Domain\Model\EventKo
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Dennis\Tournament\Domain\Model\EventKo();
	}
	 ...
	 * @test
	 */
	public function getEncounterReturnsInitialValueForEncounterKo() {
	 ...
	 * @test
	 */
	public function setEncounterForObjectStorageContainingEncounterKoSetsEncounter() {
		$encounter = new \Dennis\Tournament\Domain\Model\EncounterKo();
